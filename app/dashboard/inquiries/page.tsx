  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Submit a concern and track its status</p>
      </div>

      <div className="bg-white rounded-2xl p-5 border border-slate-100">
        <h2 className="text-sm font-semibold text-slate-800 mb-3">Submit new inquiry</h2>
      ...
      <div className="space-y-3">
        ...
        {inquiries.length === 0 ? (
          ...
          inquiries.map(inquiry => (
            <div key={inquiry.id} className="bg-white rounded-2xl p-5 border border-slate-100">
